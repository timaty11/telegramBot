...
public class KyivTr {
    ...
    public static String[] getKyivTr(String period) {


        if (period.equals("На 5 дней \ud83c\udf03")) {
            try {
                document = Jsoup.connect("https://weather.com/ru-RU/weather/5day/l/d198c31dca17aa9ac8e4ff2e4dbdb48e4ca8c01f0fd1369998f0a09f53ef0b1d").get();
